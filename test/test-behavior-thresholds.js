...
const PROFILES = {
  '直觉型快速决策者': {
    ...
    data: {
      ...
      game2: { gameId:'game2', dimensions:{ TF:9.0, GM:5.0, AU:4.0, SE:3.5, EC:6.0, SV:2.5, CH:5.5, LS:4.5 }, behaviorSummary:{ primaryAnchor:'TF', secondaryAnchor:'EC', bottomAnchor:'SV' }, meta:{ cardsViewed:6, stage1Kept:6 } },
  ...
  '审慎型慢速决策者': {
    ...
    data: {
      ...
      game2: { gameId:'game2', dimensions:{ TF:7.5, GM:5.5, AU:4.0, SE:3.0, EC:4.5, SV:6.0, CH:4.0, LS:5.5 }, behaviorSummary:{ primaryAnchor:'TF', secondaryAnchor:'SV', bottomAnchor:'SE' }, meta:{ cardsViewed:13, stage1Kept:6 } },
  ...
  '均衡探索型': {
    ...
    data: {
      ...
      game2: { gameId:'game2', dimensions:{ TF:4.0, GM:5.0, AU:8.5, SE:2.5, EC:7.5, SV:4.5, CH:5.0, LS:5.5 }, behaviorSummary:{ primaryAnchor:'AU', secondaryAnchor:'EC', bottomAnchor:'SE' }, meta:{ cardsViewed:11, stage1Kept:6 } },
  ...
  '高波动矛盾型': {
    ...
    data: {
      ...
      game2: { gameId:'game2', dimensions:{ TF:3.5, GM:7.0, AU:6.5, SE:4.0, EC:3.0, SV:5.5, CH:4.5, LS:4.0 }, behaviorSummary:{ primaryAnchor:'GM', secondaryAnchor:'AU', bottomAnchor:'EC' }, meta:{ cardsViewed:5, stage1Kept:6 } },
...
for (const [name, profile] of Object.entries(PROFILES)) {
  ...
  if (bn.g2) {
    ...
    const viewRatio = g2.cardsSelected > 0 ? g2.cardsViewed / g2.cardsSelected : 0;
    console.log(`  G2: ${g2.explorationStyle} ${ok ? '✅' : '❌ 预期'+profile.expected.g2Style} (viewed=${g2.cardsViewed}, kept=${g2.cardsSelected}, ratio=${viewRatio.toFixed(2)}, gap=${g2.anchorGap})`);
    if (!ok) allOk = false;
  }
