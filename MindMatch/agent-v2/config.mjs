...
/** Hunyuan API（DeepSeek 故障时 fallback） */
export const HUNYUAN_URL = 'https://api.hunyuan.cloud.tencent.com/v1/chat/completions';
export const HUNYUAN_MODEL = 'hunyuan-lite';
...
export function getHunyuanApiKey() {
  if (_cachedHunyuanKey) return _cachedHunyuanKey;
  _cachedHunyuanKey = process.env.HUNYUAN_API_KEY || '';
  return _cachedHunyuanKey;
}
